...
export const BATTLE = {
  ...
  LASER_TRAVEL_MS: 1000,
  LASER_WIDTH: GAME.WIDTH * 0.018,
  LASER_LENGTH: GAME.WIDTH * 0.04,
  WARRIOR_FIRE_COOLDOWN_MS: 800,
  DRAGON_FIRE_COOLDOWN_MS: 1500,
  HIT_RANGE: GAME.WIDTH * 0.06,
  STUN_MS: 500,
  INVULN_MS: 400,
};
